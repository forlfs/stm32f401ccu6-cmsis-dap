...
{
  /* USER CODE BEGIN 0 */
  /* A minimal Report Desc with INPUT/OUTPUT/FEATURE report. */
  ...
  //Feature Report
  0x95, 0x01,       /* Report Length (64 REPORT_SIZE) */
  0x09, 0x01,       /* USAGE (Vendor Usage 1) */
...
{
  /* USER CODE BEGIN 4 */
  extern void USBD_HID0_Initialize();
...
{
  /* USER CODE BEGIN 5 */
  extern void USBD_HID0_Uninitialize();
